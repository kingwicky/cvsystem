...
<head>
    ...
    <title>CV System - Dashboard</title>
</head>
<body>
    ...
    <div class="alert alert-success">
        <center><h5>Welcome, {{session('name')}}, to the CV creator system. We are delighted to have you on board <i class="fa fa-heart" aria-hidden="true" style="color:red"></i></h5></center>
    </div>
    ...
    <div class="row jumbotron box8">
      <div class="col-sm-12 mx-t3 mb-4">
        <h2 class="text-center text-info">Check & update your CV here</h2>
      </div>
      ...
      <div class="col-sm-12 form-group">
        <img src='{{ url("$profileImageLink") }}' width="250" id="profile-image" style="cursor:pointer">
      ...
      <div class="col-sm-12 form-group">
        ...
        <input type="text" class="form-control" name="title" id="title" placeholder="Enter the title of your CV." value="{{$info->title}}" required>
      </div>

      <div class="col-sm-12 form-group">
        <label for="summary">Write something about you</label>
        <textarea class="form-control" name="summary" id="summary">{{$info->summary}}</textarea>
      </div>


      <div class="col-sm-6 form-group">
        <label for="fname">First Name</label>
        <input type="text" class="form-control" name="fname" id="fname" value="{{$info->fname}}" placeholder="Enter your first name." required>
      </div>
      <div class="col-sm-6 form-group">
        <label for="lname">Last name</label>
        <input type="text" class="form-control" name="lname" id="lname" value="{{$info->lname}}" placeholder="Enter your last name." required>
      </div>
      ...
      <div class="col-sm-4 form-group">
        ...
        <input type="tel" name="phone" class="form-control" id="tel" value="{{$info->mobile}}" placeholder="Enter Your Contact Number." required>
      </div>
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="address" class="form-control" name="Locality" id="address1" value="{{$info->address1}}" placeholder="Locality/House/Street no." required>
      </div>
      <div class="col-sm-6 form-group">
        <label for="address2">Address Line-2</label>
        <input type="address" class="form-control" name="address" id="address2" value="{{$info->address2}}" placeholder="Village/City Name." required>
      </div>
      <div class="col-sm-4 form-group">
        <label for="state">State</label>
        <input type="address" class="form-control" name="State" id="state" value="{{$info->state}}" placeholder="Enter your state name." required>
      </div>
      <div class="col-sm-2 form-group">
        <label for="zip">Postal-Code</label>
        <input type="zip" class="form-control" name="Zip" id="zip" value="{{$info->zip}}" placeholder="Postal-Code." required>
      </div>
      <div class="col-sm-6 form-group">
      ...
      <div class="col-sm-6 form-group">
        ...
        <input type="Date" name="dob" class="form-control" id="dob" value="{{$info->dob}}" required>
      </div>
      <div class="col-sm-6 form-group">
        ...
        <select id="sex" class="form-control browser-default custom-select">
          ...
          <option value="Unspesified" @if($info->gender == 'Unspesified') selected @endif>Unspecified</option> -->
            ...
            <table class="table table-striped table-hover">
              ...
              @if(!empty($info->educations))
                    ...
                    <tr>
                        ...
                        <td>{{$edu->year}}</td>
                        <td>{{$edu->status}}</td>
                        <td><a href='javascript:void(0)' class='btn btn-danger' onclick="removeEduItem('{{$edu->id}}')"><i class='fas fa-trash-alt'></i></a></td>
                    </tr>
        ...
        <tbody id="exp-table-body">
            ...
            @if(!empty($info->experiences))
                ...
                <tr>
                    ...
                    <td>{{$exp->company}}</td>
                    <td>{{$exp->duration}}</td>
                    <td><a href='javascript:void(0)' class='btn btn-danger' onclick="removeExpItem('{{$exp->id}}')"><i class='fas fa-trash-alt'></i></a></td>
                </tr>
                @endforeach
...
<div class="col-sm-4 form-group mb-0">
  <a href="javascript:void(0);" class="btn btn-primary float-right" id="add-lang-to-table">Add Language</a>
      ...
      <table class="table table-striped table-hover">
        ...
        @if(!empty($info->languages))
            ...
            <tr>
                ...
                <td>{{$lang->language}}</td>
                <td>{{$lang->level}}</td>
                <td><a href='javascript:void(0)' class='btn btn-danger' onclick="removeLangItem('{{$lang->id}}')"><i class='fas fa-trash-alt'></i></a></td>
            </tr>
      ...
      <div class="col-sm-6 form-group mb-0" style="margin-top : 30px;">

        <button class="btn btn-warning float-right" type="submit" style="margin-left:10px">Update My CV</button>
        <a href="{{route('preview')}}" class="btn btn-success float-right" type="submit">Preview & Download</a>
    ...
    <center><h1>You have not created your CV yet...<h1><center>
    ...
    $(document).ready(function(){
        ...
        @if(!empty($info))
            $("#sex").val("{{$info->gender}}").change();
            $("#cod").val("{{$info->country_code}}").change();
            $("#country").val("{{$info->country}}").change();
...
var level = $("#langlevel").val();
        ...
        if(language === "" || level === ""){
          ...
          "<td><a href='javascript:void(0)' class='btn btn-danger' onclick='removeTempLangItem("+index+")'><i class='fas fa-trash-alt'></i></a></td></tr>";
...
var duration = $("#expfromto").val();
        ...
        if(position === "" || company === "" || duration === ""){
          ...
          "<td><a href='javascript:void(0)' class='btn btn-danger' onclick='removeTempExpItem("+index+")'><i class='fas fa-trash-alt'></i></a></td></tr>";
...
/////////////ADD EXP END///////////////
      ...
      $("#add-edu-to-table").click(function(){
          ...
          if(school === "" || year === ""){
            ...
            "<td><a href='javascript:void(0)' class='btn btn-danger' onclick='removeTempEduItem("+index+")'><i class='fas fa-trash-alt'></i></a></td></tr>";
...
// ADD EDU END/////////////////
    ...
    function refreshLangTable(){
        ...
        for(var i = 0;i<langList.length;i++){
              ...
              "<td><a href='javascript:void(0)' class='btn btn-danger' onclick='removeTempLangItem("+item.id+")'><i class='fas fa-trash-alt'></i></a></td></tr>";
    ...
    function removeTempLangItem(id){
    ...
    function refreshExpTable(){
        ...
        for(var i = 0;i<expList.length;i++){
              ...
              "<td><a href='javascript:void(0)' class='btn btn-danger' onclick='removeTempExpItem("+item.id+")'><i class='fas fa-trash-alt'></i></a></td></tr>";
    ...
    function refreshEduTable(){
        ...
        for(var i = 0;i<eduList.length;i++){
              ...
              "<td><a href='javascript:void(0)' class='btn btn-danger' onclick='removeTempEduItem("+item.id+")'><i class='fas fa-trash-alt'></i></a></td></tr>";
...
$.ajax({
  ...
  console.error(error);
        ...
        function removeLangItem(langId){
