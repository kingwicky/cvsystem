...
@media only screen and (max-width: 400px) {
  i {
    ...
    <div class="form-toggle">
        <button id="login-toggle" onclick="toggleLogin()">Cpanel log in</button>
    ...
    <div id="login-form">
        <form id="form-login">
          @csrf
            <input type="text" name="username" placeholder="Enter cpanel username"/>
            <input type="password" name="pwd" placeholder="Enter cpanel password"/>
            <button type="submit" class="btn login">login to cpanel</button>
